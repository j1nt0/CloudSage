...
class SkinsData {
    ...
    init() {
        skins = [
                        ...
                        Skin(skinTitle: "15년 전 구름총각 시절", skinString: "SkinPaul", isPremium: false, isUnLock: true),
                        Skin(skinTitle: "엘프가 될뻔한 영감", skinString: "SkinElf", isPremium: false, isUnLock: true),
                        Skin(skinTitle: "핑크 거대 토끼", skinString: "SkinPinkGiantRabbit", isPremium: true, isUnLock: false),
                        Skin(skinTitle: "테무에서 산 한교동", skinString: "SkinZZabGyoDong", isPremium: true, isUnLock: false),
